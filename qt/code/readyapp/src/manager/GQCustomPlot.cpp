...
// constructor
//===============================================
GQCustomPlot::GQCustomPlot(QWidget* parent) : GWidget(parent) {
    setObjectName("GQCustomPlot");
...
// method
//===============================================
void GQCustomPlot::slotItemClick() {
    sGApp* lApp = GManager::Instance()->getData()->app;
...
//===============================================
void GQCustomPlot::slotItemClick(QAction* action) {
    sGApp* lApp = GManager::Instance()->getData()->app;
