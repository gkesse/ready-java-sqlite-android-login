...
//===============================================
void GOpenCVSys::run_BASIS_POINT(int argc, char** argv) {
    printf("\n");
    printf("%s\n", __FUNCTION__);
...
//===============================================
void GOpenCVSys::run_BASIS_FUNCTION(int argc, char** argv) {
    printf("\n");
    printf("%s\n", __FUNCTION__);
...
//===============================================
void GOpenCVSys::run_IMAGE_INVERT_IMAGE_PATH(int argc, char** argv) {
    std::string lLast = GConfig::Instance()->getData("CPP_IMAGE_PATH");
    printf("CPP_IMAGE_PATH (%s) ? : ", lLast.c_str());
    std::string lAnswer; std::getline(std::cin, lAnswer);
    if(lAnswer == "") lAnswer = lLast;
...
//===============================================
void GOpenCVSys::run_IMAGE_INVERT_IMAGE_NAME(int argc, char** argv) {
    std::string lLast = GConfig::Instance()->getData("CPP_IMAGE_NAME");
    printf("CPP_IMAGE_NAME (%s) ? : ", lLast.c_str());
    std::string lAnswer; std::getline(std::cin, lAnswer);
    if(lAnswer == "") lAnswer = lLast;
...
//===============================================
void GOpenCVSys::run_IMAGE_INVERT(int argc, char** argv) {
    printf("\n");
    printf("%s\n", __FUNCTION__);
    std::string lImagePath = "";
    lImagePath += GConfig::Instance()->getData("CPP_IMAGE_PATH");
...
//===============================================
void GOpenCVSys::run_VIDEO_LOAD_VIDEO_PATH(int argc, char** argv) {
...
//===============================================
void GOpenCVSys::run_VIDEO_LOAD_VIDEO_NAME(int argc, char** argv) {
...
//===============================================
void GOpenCVSys::run_VIDEO_LOAD(int argc, char** argv) {
    printf("\n");
    printf("%s\n", __FUNCTION__);
...
//===============================================
void GOpenCVSys::run_VIDEO_TRACKBAR_VIDEO_PATH(int argc, char** argv) {
    std::string lLast = GConfig::Instance()->getData("CPP_VIDEO_PATH");
    printf("CPP_VIDEO_PATH (%s) ? : ", lLast.c_str());
    std::string lAnswer; std::getline(std::cin, lAnswer);
    if(lAnswer == "") lAnswer = lLast;
...
//===============================================
void GOpenCVSys::run_VIDEO_TRACKBAR_VIDEO_NAME(int argc, char** argv) {
    std::string lLast = GConfig::Instance()->getData("CPP_VIDEO_NAME");
    printf("CPP_VIDEO_NAME (%s) ? : ", lLast.c_str());
    std::string lAnswer; std::getline(std::cin, lAnswer);
    if(lAnswer == "") lAnswer = lLast;
...
//===============================================
void GOpenCVSys::run_VIDEO_TRACKBAR(int argc, char** argv) {
    printf("\n");
    printf("%s\n", __FUNCTION__);
    std::string lVideoPath = "";
    lVideoPath += GConfig::Instance()->getData("CPP_VIDEO_PATH");
