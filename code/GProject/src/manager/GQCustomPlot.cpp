...
void GQCustomPlot::test(int argc, char** argv) {
	...
	for(int i = 2; i < argc;) {
		string lKey = argv[i++];
		if(lKey == "defa") {testDefault(argc, argv); lRunFlag = 1; break;}
		if(lKey == "quad") {testQuadratic(argc, argv); lRunFlag = 1; break;}
		if(lKey == "simp") {testSimple(argc, argv); lRunFlag = 1; break;}
		if(lKey == "sisc") {testSincScatter(argc, argv); lRunFlag = 1; break;}
		if(lKey == "scst") {testScatterStyle(argc, argv); lRunFlag = 1; break;}
		if(lKey == "list") {testLineStyle(argc, argv); lRunFlag = 1; break;}
		if(lKey == "scpi") {testScatterPixmap(argc, argv); lRunFlag = 1; break;}
		if(lKey == "date") {testDate(argc, argv); lRunFlag = 1; break;}
		if(lKey == "tebr") {testTextureBrush(argc, argv); lRunFlag = 1; break;}
		if(lKey == "muax") {testMultiAxis(argc, argv); lRunFlag = 1; break;}
		if(lKey == "loga") {testLogarithmic(argc, argv); lRunFlag = 1; break;}
		if(lKey == "reda") {testRealtimeData(argc, argv); lRunFlag = 1; break;}
		if(lKey == "pacu") {testParametricCurve(argc, argv); lRunFlag = 1; break;}
		if(lKey == "bach") {testBarChart(argc, argv); lRunFlag = 1; break;}
		if(lKey == "stat") {testStatistical(argc, argv); lRunFlag = 1; break;}
		if(lKey == "siit") {testSimpleItem(argc, argv); lRunFlag = 1; break;}
		if(lKey == "item") {testItem(argc, argv); lRunFlag = 1; break;}
		if(lKey == "styl") {testStyled(argc, argv); lRunFlag = 1; break;}
		if(lKey == "adax") {testAdvancedAxes(argc, argv); lRunFlag = 1; break;}
		if(lKey == "coma") {testColorMap(argc, argv); lRunFlag = 1; break;}
		if(lKey == "fina") {testFinancial(argc, argv); lRunFlag = 1; break;}
		break;
	}
	if(lRunFlag == 0) help(argc, argv);
}
//===============================================
void GQCustomPlot::help(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	...
	printf("\n");
	printf("%s\n", "Utilisation:");
	printf("\t\%s %s : %s\n", lModule, "test", "afficher aide");
	printf("\t\%s %s : %s\n", lModule, "test defa", "afficher defaut");
	printf("\t\%s %s : %s\n", lModule, "test simp", "setupSimpleDemo");
	printf("\t\%s %s : %s\n", lModule, "test sisc", "setupSincScatterDemo");
	printf("\t\%s %s : %s\n", lModule, "test scst", "setupScatterStyleDemo");
	printf("\t\%s %s : %s\n", lModule, "test list", "setupLineStyleDemo");
	printf("\t\%s %s : %s\n", lModule, "test scpi", "setupScatterPixmapDemo");
	printf("\t\%s %s : %s\n", lModule, "test date", "setupDateDemo");
	printf("\t\%s %s : %s\n", lModule, "test tebr", "setupTextureBrushDemo");
	printf("\t\%s %s : %s\n", lModule, "test muax", "setupMultiAxisDemo");
	printf("\t\%s %s : %s\n", lModule, "test loga", "setupLogarithmicDemo");
	printf("\t\%s %s : %s\n", lModule, "test reda", "setupRealtimeDataDemo");
	printf("\t\%s %s : %s\n", lModule, "test pacu", "setupParametricCurveDemo");
	printf("\t\%s %s : %s\n", lModule, "test bach", "setupBarChartDemo");
	printf("\t\%s %s : %s\n", lModule, "test stat", "setupStatisticalDemo");
	printf("\t\%s %s : %s\n", lModule, "test siit", "setupSimpleItemDemo");
	printf("\t\%s %s : %s\n", lModule, "test item", "setupItemDemo");
	printf("\t\%s %s : %s\n", lModule, "test styl", "setupStyledDemo");
	printf("\t\%s %s : %s\n", lModule, "test adax", "setupAdvancedAxesDemo");
	printf("\t\%s %s : %s\n", lModule, "test coma", "setupColorMapDemo");
	printf("\t\%s %s : %s\n", lModule, "test fina", "setupFinancialDemo");
	printf("\n");
}
//===============================================
void GQCustomPlot::testDefault(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
...
//===============================================
void GQCustomPlot::testQuadratic(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	...
	customPlot->setWindowTitle("QCustomPlot | ReadyDev");
	customPlot->resize(640, 480);
	customPlot->show();
	lApp.exec();
}
//===============================================
void GQCustomPlot::testSimple(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testSincScatter(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testScatterStyle(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testLineStyle(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testScatterPixmap(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
	...
	// setup legend:
	customPlot->legend->setFont(QFont(customPlot->font().family(), 7));
...
//===============================================
void GQCustomPlot::testDate(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testTextureBrush(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testMultiAxis(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
	...
	customPlot->legend->setVisible(true);
	QFont legendFont = customPlot->font();  // start out with MainWindow's font..
...
//===============================================
void GQCustomPlot::testLogarithmic(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testRealtimeData(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
	...
	connect(dataTimer, SIGNAL(timeout()), this, SLOT(slotRealtimeData()));
...
//===============================================
void GQCustomPlot::testParametricCurve(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testBarChart(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testStatistical(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testSimpleItem(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
	...
	textLabel->setFont(QFont(customPlot->font().family(), 16)); // make font a bit larger
...
//===============================================
void GQCustomPlot::testItem(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
	...
	wavePacketText->setFont(QFont(customPlot->font().family(), 10));
	...
	phaseTracerText->setFont(QFont(customPlot->font().family(), 9));
	...
	groupTracerText->setFont(QFont(customPlot->font().family(), 9));
	...
	dispersionText->setFont(QFont(customPlot->font().family(), 10));

	QTimer* dataTimer = new QTimer(this);
	// setup a timer that repeatedly calls MainWindow::bracketDataSlot:
	connect(dataTimer, SIGNAL(timeout()), this, SLOT(slotBracketData()));
	dataTimer->start(0); // Interval 0 means to refresh as fast as possible
...
//===============================================
void GQCustomPlot::testStyled(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testAdvancedAxes(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testColorMap(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::testFinancial(int argc, char** argv) {
	GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	GEnv::Instance()->setEnv();
	QApplication lApp(argc, argv);
	QCustomPlot* customPlot = new QCustomPlot;
...
//===============================================
void GQCustomPlot::slotRealtimeData() {
	//GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	...
	{
		// add data to lines:
		m_customPlot->graph(0)->addData(key, qSin(key)+qrand()/(double)RAND_MAX*1*qSin(key/0.3843));
		m_customPlot->graph(1)->addData(key, qCos(key)+qrand()/(double)RAND_MAX*0.5*qSin(key/0.4364));
...
//===============================================
void GQCustomPlot::slotBracketData() {
	//GDebug::Instance()->write(__CLASSNAME__, "::", __FUNCTION__, "()", _EOA_);
	...
	if (key-lastFpsKey > 2) // average fps over 2 seconds
	{
		qDebug() <<
				QString("%1 FPS, Total Data points: %2")
				.arg(frameCount/(key-lastFpsKey), 0, 'f', 0)
				.arg(m_customPlot->graph(0)->data()->size());
		qDebug() << "\n";
		lastFpsKey = key;
		frameCount = 0;
	}
